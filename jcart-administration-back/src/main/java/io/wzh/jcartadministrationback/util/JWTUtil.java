package io.wzh.jcartadministrationback.util;
...
import io.wzh.jcartadministrationback.dto.out.AdministrLonginOutDTO;
import io.wzh.jcartadministrationback.pogo.Administrator;
import io.wzh.jcartadministrationback.vo.AdministratorLoginVO;
...
public class JWTUtil {
    ...
    public AdministrLonginOutDTO issueToken(Administrator administrator) {
        Date now = new Date();
        ...
        AdministrLonginOutDTO administratorLoginOutDTO = new AdministrLonginOutDTO();
