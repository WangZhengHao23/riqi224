...
import io.wzh.jcartadministrationback.dto.in.ReturnHistoryCreateInDTO;
import io.wzh.jcartadministrationback.dto.out.ReturnHistoryListOutDTO;
...
public class ReturnHistoryController {
    ...
    public List<ReturnHistoryListOutDTO> getListByReturnId(@RequestParam Integer returnId){
        List<ReturnHistory> returnHistories = returnHistoryService.getistByreturnId(returnId);
